...
import org.openerproject.targetproperties.svector.indexing.CustomLuceneUtils;
 ...
 */
public class CustomLSA {
  private static final Logger logger = Logger.getLogger(CustomLSA.class.getCanonicalName());
  ...
  private CustomLuceneUtils luceneUtils;
   ...
   * @throws IOException
   */
  private CustomLSA(String luceneIndexDir, FlagConfig flagConfig) throws IOException {
    this.flagConfig = flagConfig;    
    this.luceneUtils = new CustomLuceneUtils(flagConfig);
  ...
  public static void main(String[] args) throws IllegalArgumentException, IOException {
    ...
    CustomLSA lsaIndexer = new CustomLSA(flagConfig.luceneindexpath(), flagConfig);
